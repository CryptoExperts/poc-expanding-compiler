...
def replace_mult_instruction(mult_instruction, mult_gadget_dict, nb_shares, random_suffix):
    ...
    gad_inp1 = mult_gadget_dict["inputs"][0]
    gad_inp2 = mult_gadget_dict["inputs"][1]
    gad_out = mult_gadget_dict["outputs"][0]
    
    replacement = copy.deepcopy(mult_gadget_dict["instructions"])
